    ...
    private function generateUniqueSKU()
{
    ...
    // Create the SKU by concatenating "Insta-" with the random number
    $sku = "Insta-" . $randomNumber;
    // Check if the SKU exists in the products table
    // You would need to replace 'Product' with the actual model name for your products
