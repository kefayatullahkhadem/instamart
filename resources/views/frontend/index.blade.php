...
@section('content')
        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif">
                    ...
                    @endif
                    @if (count($featured_categories) > 0)
                        <ul class="list-unstyled mb-0 row gutters-5" id="todaydeals">
                ...
                @if($num_todays_deal > 0)
                    <div class="col-lg-2 order-3 mt-3 mt-lg-0" id="todaydeals">
    ...
    @if($flash_deal != null && strtotime(date('Y-m-d H:i:s')) >= $flash_deal->start_date && strtotime(date('Y-m-d H:i:s')) <= $flash_deal->end_date)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container bg-white" style="padding-top:10px; padding-bottom:10px;border-radius: 5px;">
                <!-- Top Section -->
    ...
    @endif
    <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="mobdeal">
        <div class="container">
            {{--            <div class="bg-white">--}}
            {{--                <!-- Top Section -->--}}
    ...
    <!-- Featured Categories -->
    @if (count($featured_categories) > 0)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="todaydeals">
            <div class="container bg-white" style="padding-top:10px; padding-bottom:10px;border-radius: 5px;">
                <div class="bg-white">
                    <!-- Top Section -->
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    ...
                    @foreach ($best_selers as $key => $seller)
                        @if ($seller->user != null)
                            <div class="carousel-box h-100 position-relative text-center border-right border-top border-bottom @if($key==0) border-left @endif has-transition hov-animate-outline">
                                <div class="position-relative px-3" style="padding-top: 2rem; padding-bottom:2rem; background-color: white;">
