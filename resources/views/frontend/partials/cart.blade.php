...
<a href="javascript:void(0)" class="d-flex align-items-center text-gray  h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <span class="mr-2">
    ...
    <span class="d-none d-xl-block ml-2 fs-14 fw-700 text-gray">{{ single_price($total) }}</span>
...
<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
    @if (isset($cart) && count($cart) > 0)
        ...
        <!-- Cart Products -->
        <ul class="h-180px overflow-auto c-scrollbar-light list-group list-group-flush mx-1">
            @foreach ($cart as $key => $cartItem)
                @php
                    $product = \App\Models\Product::find($cartItem['product_id']);
                @endphp
