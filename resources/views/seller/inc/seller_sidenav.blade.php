    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3">
                ...
                <p class="text-primary"><b>SHOP ID - {{env('SELLER_PREFIX')}}{{ Auth::user()->id }}</b></p>
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.categories.comission') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.categories.comission']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Category Comissions') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
