...
Route::get('fetch-cities', 'App\Http\Controllers\HomeController@getCity');
Route::get('fetch-city-cost', 'App\Http\Controllers\HomeController@getCityCost');
Route::get('get-cityx', 'App\Http\Controllers\HomeController@getcityx');
