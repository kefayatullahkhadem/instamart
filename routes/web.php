...
use App\Http\Controllers\Payment\WebxpayController;
...
//Webxpay START
Route::controller(WebxpayController::class)->group(function () {
    Route::get('/webxpay/payment', 'getDone')->name('webxpay.callback');
});
